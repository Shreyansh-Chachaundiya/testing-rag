"""
Order Export API — exports order data to external analytics.

This file intentionally calls a non-existent service (ServiceX)
that does NOT exist in either the PR or the main branch.
Both pipelines should flag this as an undefined reference.
"""
...
# This import does NOT exist anywhere — not in PR, not in main.
# Both old and new pipelines should flag this.
...
async def export_user_orders(
    ...
    try:
        ...
        # ExportServiceX does not exist — this is a true missing dependency
